...
Quantitative Analysis
Asymmetrical Risk and of allocation, selection and interaction is
Return typically positive or negative. In contrast, our
attribution of asymmetrical alpha and beta
Asymmetries in risk and return characteristics will be free of any interaction effects and we
come in various forms: assets with highly will show that the sum of effects on alpha and
Attribution Analysis of Bull/Bear
non-linear payoff profiles, correlations which beta will always equal zero; asymmetry is a
increase in times of market turbulence, zero sum game when evaluated relative to a
Alphas and Betas
successful information-driven market timing symmetrical model.
strategies and data-driven dynamic portfolio
with Applications to Downside Risk Management The zero sum property of relative effects
...
This contrasts strongly with traditional models, asymmetrical models can be used in ex post
which are dominated by symmetric risk portfolio analysis to detect “false” alphas
measures such as volatility and beta: A return caused by “hidden” asymmetrical betas.
Andreas Steiner
of 15% below the mean has the same impact Additionally, asymmetrical betas can be
Andreas Steiner Consulting GmbHt
on volatility as a return of 15% above the mean; used in ex ante portfolio construction for the
the beta of a portfolio is 0.85, independent purpose of downside risk management.
...
r =α+β⋅r +ε
In this research note, we will discuss a specific P,t B,t t
...
Cov r ,r
which differ from traditional attribution β= P B
σ2
analysis of portfolio returns. For example, in B
a Brinson decomposition we are used to The above linear relationship is exact at one
having an interaction effect and the sum
74 75
Alternative Investment Analyst Review Attribution Analysis of Bull/Bear Alphas and Beta Attribution Analysis of Bull/Bear Alphas and Beta Alternative Investment Analyst Review


<!-- Page 2 -->

Quantitative Analysis Quantitative Analysis
point, namely average portfolio and benchmark return.
r =α+β⋅r The statistical properties of the asymmetrical index model would require more detailed discussion than is possible
P B
...
α=r −β⋅r
P B of the above dual alpha and dual beta model can be recovered. In order to keep the presentation as clear as
We see that Alpha is not calculated directly, but as the residual not explained by the return contribution of Beta. possible, we continue using the intuitive dual alpha / dual beta model introduced above.
...
( ) ( )
r ≠ α +α + β +β ⋅r +ε
world in which benchmark returns are negative. Similarly, bull markets are defined as states of the world in which P,t Bull Bear Bull Bear B,t t
...
r =α+β⋅r +ε
the bear and bull market data sets separately. We run the following regressions. P,t B,t t
r =α +β ⋅r +ε Second Step: Estimate incremental asymmetrical Alphas and Betas by regressing the residuals ε on the dummy
P,Bull,t Bull Bull B,Bull,t Bull,t
variables and benchmark returns.
r =α +β ⋅r +ε ε=∆α ⋅Ι +∆α ⋅Ι +∆β ⋅r ⋅Ι +∆β ⋅r ⋅Ι +ε′
P,Bear,t Bear Bear B,Bear,t Bear,t t Bear Bear,t Bull Bull,t Bear B,t Bear Bull B,t Bull,t t
...
α =α+∆α
Bear Bear
comparing regression parameters across bull and bear markets, we would test whether or not asymmetrical risk α =α+∆α
Bull Bull
and return characteristics are relevant.
β =β+∆β
Bull Bull
It would be very convenient if the parameters are additive. Unfortunately, this is not the case; it can be shown β =β+∆β
Bear Bear
that.
Inserting the definition of the incremental effects into the equation in the second step, and then substituting ε in
α +α ≠α
Bear Bear step one, we get.
β +β ≠β r =α+β⋅r +(α −α)⋅Ι +(α −α)⋅Ι +...
Bear Bear P,t B,t Bear Bear,t Bull Bull,t
... (β −β)⋅r ⋅Ι +(β −β)⋅r ⋅Ι +ε
Bear B,t Bear,t Bull B,t Bull,t t
The calculations can be simplified by introducing dummy variables, which are binary indicators of whether the
state of the world at time t is a bull or bear market. This simplifies to.
0 r <0 r P,t =α Bear ⋅Ι Bear,t +α Bull ⋅Ι Bull,t +β Bear ⋅r B,t ⋅Ι Bear,t +β Bull ⋅r B,t ⋅Ι Bull,t +ε t
Ι = B,t
Bull,t

1 r
...
0 r ≥0
Ι = B,t relationship between the parameters of the two models.
Bear,t  1 r <0 We now define an Alpha effect a, which measures the return contribution of the incremental alphas.
B,t
a= p ⋅∆α + p ⋅∆α
Bear Bear Bull Bull
With the help of these indicators, we estimate bull and bear parameters from a single regression, which we call
...
r =α ⋅Ι +α ⋅Ι +β ⋅r ⋅Ι +β ⋅r ⋅Ι +ε
P,t Bull Bull,t Bear Bear,t Bull B,t Bull,t Bear B,t Bear,t t
76 77
Alternative Investment Analyst Review Attribution Analysis of Bull/Bear Alphas and Beta Attribution Analysis of Bull/Bear Alphas and Beta Alternative Investment Analyst Review
...
Exhibits 1:
Quantitative Analysis Quantitativ e Analysis
Exhibit E2x:hibit 2: “contribution from asymmetry”.
a= p ⋅α + p ⋅α −α
Bear Bear Bull Bull p ⋅α + p ⋅α −α=ContrAsymmetry
Bear Bear Bull Bull
...
ContrAsymmetry=β⋅r −β ⋅r ⋅Ι −β ⋅r ⋅Ι
b=∆β ⋅r ⋅Ι +∆β ⋅r ⋅Ι B Bear B Bear Bull B Bull
Bear B Bear Bull B Bull
b=β ⋅r ⋅Ι +β ⋅r ⋅Ι −β⋅r The contribution from asymmetry consists of redistribution
Bear B Bear Bull B Bull B
...
r =α+β⋅r =Ι ⋅α +Ι ⋅α +β ⋅r ⋅Ι +β ⋅r ⋅Ι
P B Bear Bear Bull Bull Bear B Bull Bull B Bull For concave dependencies, the redistribution takes place
in the other direction.
From the above, it follows that.
r −r =a+b=0 This means that assessing convex investment strategies with
P,SingleIndexModel P,DualAlphaDualBetaModel
...
Exhibit E3x:hibit 3: Alphas: The single-index model indicates “false Alphas
...
Note what the above does not imply. The purpose of our bull/bear attribution approach is to
...
r ⋅Ι ⋅∆β +r ⋅Ι ⋅∆β ≠0 Alphas and Betas into contributions from portfolio
B Bear Bear B Bull Bull
...
P i i P i i
i=1 i=1
where w represents the percentage weight of a constituent in the portfolio.
The expected value of the dummy variables can be
Ex Post Attribution for a Sample Fund of Hedge Funds
Exhibit 7: interpreted as probabilities: the probability of a bear
...
0.410). The asymmetric Betas imply that the investment strategy is convex. This can be seen graphically, when The total Alpha effect of -0.756% is the negative of
plotting actual and fitted portfolio returns against benchmark returns. the total Beta effect 0.756%. This reflects the zero
...
Quantitative Analysis Quantitative Analysis
Exhibit 9: over symmetrical strategies” in absolute terms. The bull/bear alpha and beta attribution of the resulting portfolio looks like this.
...
two factor models and attributing the differences to The maximum return portfolio is presented graphically in Exhibit 7.
...
Exhibit 11: for such an optimized portfolio are provided in Exhibits 8 and 9.
(portfolio optimization). In addition to the targets,
we can specify portfolio properties that need to be As we can see from the chart, the strategy is convex, as we required. Interestingly, the return of the portfolio is
fulfilled (restrictions). virtually the same (it is slightly lower) as the return of the optimized portfolio without beta restrictions. Hence, we
...
portfolio shall not be leveraged (total risk exposure Another example would be the construction of a low risk “absolute return product”, in the sense of a portfolio
= 100%) and prohibit position-level leverage (each with bear beta equal to zero and a bull beta equal to 0.5. We present the results for the optimal absolute return
constituent weight <= 100%) as well as short positions product in Exhibits 10 and 11, leaving the interpretation to the reader.
...
Exhibit 10: empirical work is required which, for example, examines the out-of-sample performance of optimized bull/bear
portfolios.
