...
Overfitting, Underfitting and General Model Overconfidence and… 485
...
Overfitting, Underfitting and General Model Overconfidence and… 487
...
Overfitting, Underfitting and General Model Overconfidence and… 489
...
showed that feature selection can contaminate (i.e. bias) CV-d erived error esti-
...
Overfitting, Underfitting and General Model Overconfidence and… 491
...
Overfitting, Underfitting and General Model Overconfidence and… 493
...
the estimate and/or the 95% credible interval (Cr I) must also be taken into account
...
population is P.
X% Credible Interval (Cr I) of a point estimate P of the performance of
...
The Cr I may be viewed—in Bayesian terms—as equivalent in meaning to the
...
however, the Cr I can and is often estimated empirically with various
procedures.
...
Overfitting, Underfitting and General Model Overconfidence and… 495
...
Overfitting, Underfitting and General Model Overconfidence and… 497
...
Overfitting, Underfitting and General Model Overconfidence and… 499
...
Overfitting, Underfitting and General Model Overconfidence and… 501
...
Overfitting, Underfitting and General Model Overconfidence and… 503
...
Overfitting, Underfitting and General Model Overconfidence and… 505
...
Overfitting, Underfitting and General Model Overconfidence and… 507
...
Overfitting, Underfitting and General Model Overconfidence and… 509
...
Overfitting, Underfitting and General Model Overconfidence and… 511
...
Overfitting, Underfitting and General Model Overconfidence and… 513
...
Overfitting, Underfitting and General Model Overconfidence and… 515
...
Overfitting, Underfitting and General Model Overconfidence and… 517
10.1.14. Insufficient studies of scalability and generalizability in bespoke
hand-created AI models.
...
Overfitting, Underfitting and General Model Overconfidence and… 519
10.1.19. Whenever possible, use reanalysis (with both original and unbiased
or otherwise improved protocols, including single coordinated protocols as
needed) when verifying the validity of models produced by third parties.
10.1.20. Use domain knowledge and related face-validity tests by experts to
...
TR accuracy 0.95 0.90 0.75 0.65
Estimated generalization accuracy by CV 0.80 0.88 0.78 0.70
Estimated generalization accuracy by 0.9 0.96 0.92 0.80
Estimator X
True generalization accuracy 0.80 0.88 0.76 0.73
MS1 selects model Yes No Yes Yes
MS2 selects model Yes Yes Yes Yes
MS3 considers model No Yes No Yes
...
Overfitting, Underfitting and General Model Overconfidence and… 521
...
Algorithm A
Accuracy in Accuracy in Best Accuracy in TE of Finally reported
TRTE for H = 1 TRTE for H = 2 value of model with best value accuracy of best
H of H model
0.80 0.90 2 0.85 0.85
...
TRTE for H = 1 TRTE for H = 2 value of model with best value accuracy of best
H of H model
0.85 0.80 1 0.80 0.80


<!-- Page 46 -->

522 C. Aliferis and G. Simon
...
Algorithm Accuracy Accuracy Best Accuracy in TE Finally
A in TRTE in TRTE algorithm/best of model with reported
for H = 1 for H = 2 value of H: best algorithm/ estimated
0.80 0.90 Algorithm A, best value of H generalization
Algorithm Accuracy Accuracy H = 2 0.85 accuracy of
B in TRTR in TRTE best model
for H = 1 for H = 2 0.85
0.85 0.80
...
Overfitting, Underfitting and General Model Overconfidence and… 523
10. [ADVANCED]
...
References
1. Mitchell TM. Machine learning, vol. 1. New York: Mc Graw-hill; 2007.
2. Simon R, Radmacher MD, Dobbin K, Mc Shane LM. Pitfalls in the use of DNA microarray
...
development from microarray data. PLo S One. 2009;4(3):e4922.
...
15. Mc Dermott MB, Wang S, Marinsek N, Ranganath R, Foschini L, Ghassemi
M. Reproducibility in machine learning for health research: still a ways to go. Sci Transl Med.
2021;13(586):eabb1655.
16. Shi L, Campbell G, Jones WD. The Micro Array quality control (MAQC)-II study of com-
