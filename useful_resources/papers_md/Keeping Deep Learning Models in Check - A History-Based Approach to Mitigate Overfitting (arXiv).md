# Keeping Deep Learning Models in Check - A History-Based Approach to Mitigate Overfitting (arXiv)

> *Source PDF: Keeping Deep Learning Models in Check - A History-Based Approach to Mitigate Overfitting (arXiv).pdf*
