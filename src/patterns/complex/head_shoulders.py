        ...
        for i in range(len(peaks) - 2):
            ...
            for j in range(i + 1, len(peaks) - 1):
                ...
                for k in range(j + 1, len(peaks)):
                    ...
                    # Calculate neckline
                    neckline_slope = (trough2[1] - trough1[1]) / (trough2[0] - trough1[0]) if trough2[0] != trough1[0] else 0
                    neckline_intercept = trough1[1] - (neckline_slope * trough1[0])
                    
                    # Pattern depth
                    pattern_depth = head[1] - ((neckline_slope * right_shoulder[0]) + neckline_intercept)
        ...
        for i in range(len(troughs) - 2):
            ...
            for j in range(i + 1, len(troughs) - 1):
                ...
                for k in range(j + 1, len(troughs)):
                    ...
                    # Calculate neckline
                    neckline_slope = (peak2[1] - peak1[1]) / (peak2[0] - peak1[0]) if peak2[0] != peak1[0] else 0
                    neckline_intercept = peak1[1] - (neckline_slope * peak1[0])
                    
                    # Pattern depth
                    pattern_depth = ((neckline_slope * right_shoulder[0]) + neckline_intercept) - head[1]
