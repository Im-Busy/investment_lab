...
from ..patterns.base import TradeSignal
...
class EventWeightedAggregator:
    ...
    def aggregate(
        ...
        base_confidence = sum(s.confidence * s.event_weight for s in event_signals) / total_weight
    ...
    def get_pattern_coverage(self) -> Dict[str, float]:
        ...
        for mapping in self.pattern_mappings:
            event_type_counts[mapping.event_type] = event_type_counts.get(mapping.event_type, 0) + 1
