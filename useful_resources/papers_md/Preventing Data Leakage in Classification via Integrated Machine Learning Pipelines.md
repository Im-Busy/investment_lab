...
> *Source PDF: Preventing Data Leakage in Classification via Integrated Machine Learning Pipelines.pdf*
...
Vol. 7, No. 1, February 2026, Page. 391-410

https://jutif.if.unsoed.ac.id

  DOI: https://doi.org/10.52436/1.jutif.2026.7.2.5490
...
Mengidentifikasi ratusan
publikasi terdampak data
leakage serta merumuskan
taksonomi sistematis jenis
kebocoran data
...
leakage dapat meningkatkan
performa model secara
signifikan, terutama pada
dataset berukuran kecil

Konteks terbatas pada
domain tertentu;
generalisasi ke data
tabular perlu kajian
lanjutan

Mengusulkan alat untuk
mendeteksi indikasi data
leakage dan memberikan
...
•  Mempermudah  parameter

tuning,  karena  GridSearchCV  dapat  menyetel  parameter
...
random_state : 42 (untuk menjaga reprodusibilitas eksperimen)
...
transformasi preprocessing diterapkan pada data pengujian (test fold) menggunakan parameter
...
Keterangan
ID unik untuk setiap penumpang
Variabel target
Kelas tiket penumpang
Nama penumpang
Jenis kelamin penumpang
Usia penumpang
Jumlah saudara atau pasangan yang ikut
Jumlah orang tua atau anak-anak yang ikut
Nomor tiket
Harga tiket
Nomor kabin
Pelabuhan keberangkatan penumpang
...
Jumlah Fitur  Akurasi  Keterangan
...
91.01%  Akurasi tinggi, model fit terlalu baik pada data latih

72.62%  Akurasi menurun signifikan
...
Implementasi Pipeline dan Tuning Model KNN
...
(Pclass,  Sex,  Embarked)  diproses  melalui  pipeline  yang  melakukan
imputasi  modus  dan
...
Akurasi Data Latih (%) Akurasi Data Uji (%)

Akurasi CV (%)

Baseline

Anti-leakage tanpa pipeline
...
Interpretasi Implementasi Pra-Pemrosesan dan Risiko Data Leakage
...
Akurasi Data Uji (%) Gap Overfitting (Train–Test) Referensi Terkait
...
S. Dong, S. Sahri, and T. Palpanas, “Data Quality Awareness: A Journey from Traditional Data
Available:
Management
http://arxiv.org/abs/2411.03007
S. Mohammed et al., “The effects of data quality on machine learning performance on tabular
data,” Inf. Syst., vol. 132, pp. 1–50, 2025, doi: 10.1016/j.is.2025.102549.
X. Ying, “An Overview of Overfitting and its Solutions,” J. Phys. Conf. Ser., vol. 1168, no. 2,
...
S. Kaufman, S. Rosset, and C. Perlich, “Leakage in data mining: Formulation, detection, and
avoidance,” Proc. ACM SIGKDD Int. Conf. Knowl. Discov. Data Min., pp. 556–563, 2011, doi:
10.1145/2020408.2020496.
B. Ghojogh and M. Crowley, “The Theory Behind Overfitting, Cross Validation, Regularization,
Bagging,
[Online].  Available:
Boosting:
and
http://arxiv.org/abs/1905.12787
D.  Krstajic,  L.  J.  Buturovic,  D.  E.  Leahy,  and  S.  Thomas,  “Cross-validation  pitfalls  when
...
connectome-based  machine
learning  models,”  Nat.  Commun.,  pp.  1–15,  2024,  doi:
